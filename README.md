...
[`sort`](plugins/sort.lua?raw=1) | Sorts selected lines alphabetically or in [natural order](https://blog.codinghorror.com/sorting-for-humans-natural-sort-order/), ascending or descending
