...
syntax.add {
  ...
  patterns = {
    ...
    { pattern = "\\subsubsection",         type = "keyword"  },
    { pattern = "\\subsubsubsection",      type = "keyword"  },
    { pattern = "\\subsubsubsubsection",   type = "keyword"  },
    { pattern = "\\title",                 type = "keyword"  },
    { pattern = "\\subject",               type = "keyword"  },
    { pattern = "\\subsubject",            type = "keyword"  },
    { pattern = "\\subsubsubject",         type = "keyword"  },
    { pattern = "\\subsubsubsubject",      type = "keyword"  },
    { pattern = "\\subsubsubsubsubject",   type = "keyword"  },
